...
Ниже представлена таксономия данных о неявных требованиях. Предлагаю выделить 5 категорий данных требований, которые часто пропускаются (т.е. остаются неявными). Как показано в таблице, основными категориями неявных требований являются: безопасность, общедоступность, ремонтопригодность, стабильность и удобство использования. 
- ### Безопасность
